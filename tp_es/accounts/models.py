...
class UserThemePreference(models.Model):
	...
	hover_clr = models.CharField(max_length=7, default="#eef2ff", validators=[hex_color_validator])
	text_clr = models.CharField(max_length=7, default="#ffffff", validators=[hex_color_validator])
	accent_clr = models.CharField(max_length=7, default="#59e7ec", validators=[hex_color_validator])
	secondary_text_clr = models.CharField(max_length=7, default="#111827", validators=[hex_color_validator])
	container_background_base = models.CharField(max_length=7, default="#f3f0fe", validators=[hex_color_validator])
	secondary_base_clr = models.CharField(max_length=7, default="#ce9aff", validators=[hex_color_validator])
