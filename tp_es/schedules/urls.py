...
urlpatterns = [
    ...
    path("<int:schedule_id>/leave/", views.leave_schedule, name="leave_schedule"),
    ...
    path("<int:schedule_id>/activity/<int:activity_id>/check/",views.toggle_check,name="toggle_check"),
]
